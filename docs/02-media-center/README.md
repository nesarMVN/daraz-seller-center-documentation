...
- - **For Videos:** "Please note that the video size should be less then 100MB. Only support wmv, avi, mpg, mpeg, 3gp, mov, mp4, flv, f4v, m4v, m2t, mts, rmvb, vob, mkv"
  ...
  This is the default view when accessing Media Center. It contains:
                                              ...
                                              - - "Fashion"
                                                - - "Home & Living"
                                                  - - "Product Listing" (default)
                                                    ...
                                                    2. 2. **Follow Image Guidelines:**
                                                       3.    - Use high-resolution images (min 500×500 recommended for products)
                                                             -    - Keep file sizes optimized (under 3 MB)
                                                                  -    - Use white backgrounds for main product images
                                                                       ...
                                                                       - 3. **Organize by Product Line:** Create separate folders for different product lines or categories
                                                                         ...
                                                                         4. 4. **Clean Up Unused Media:** Regularly remove unused images to manage storage space
                                                                           
                                                                            5. 5. **Use Consistent Naming:** Name images consistently for easy searching
                                                                               ...
                                                                               9. |------------|-------------|
                                                                               10. | `screenshot-01-media-center-overview.png` | Media Center main page with Image tab selected |
                                                                               11. | `screenshot-02-video-tab.png` | Video tab view with no data state |
                                                                               12. | `screenshot-03-create-folder-dialog.png` | Create new folder dialog with input field |
                                                                               13. | `screenshot-04-folder-created.png` | Media Center showing newly created folder |
                                                                               14. | `screenshot-05-upload-image-modal.png` | Upload Image modal with drag-drop zone |
                                                                               15. | `screenshot-06-url-upload-tab.png` | URL Upload tab in upload modal |
                                                                               16. | `screenshot-07-inside-folder.png` | View inside a folder showing breadcrumb navigation |
                                                                              
                                                                               17. ---
                                                                              
                                                                               18. ## Technical Details
                                                                              
                                                                               19. ### API Endpoint Pattern
                                                                              
                                                                               20. Based on the platform configuration, API calls use:
                                                                               21. - **Domain:** `acs-m.daraz.com.bd`
                                                                                   - - **App Key:** `4272`
                                                                                     - - **Prefix:** `acs-m`
                                                                                       - - **Subdomain:** `daraz`
