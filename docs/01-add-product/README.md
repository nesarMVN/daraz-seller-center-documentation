...
A **Content Score** panel appears on the right side showing completion status for each section.
...
*Empty Add Product form showing Basic Information section*
...
*Product name field with AI-powered category suggestions*
...
![Category Selected Form](./images/screenshot-04-category-selected-form-expanded.png)

*Form with category selected and expanded*
...
*Product Images upload area with placeholder slots*
...
*Video upload options showing YouTube link input*
...
*Brand dropdown with search results*
...
### Specification Fields (Smart Phones Example)
...
*Brand selected with fill rate indicator updated*
...
*Variant configuration showing color family options*
...
*Variant with black color selected*
...
*Product description section with editor controls*
...
*Highlights and What's in the box input fields*
...
*Shipping dimensions and warranty configuration*
...
*Warranty type dropdown options*
...
**Sections tracked:**
1. Basic Information
   - Sub-item: "Add min 3 main images"
2. Product Specification
3. Price, Stock & Variants
4. Product Description
   - Sub-item: "Add min 1 image in description"
...
A "Tips" section provides guidance:
...
*Fashion category expanded specification fields*
...
*Dress Length dropdown showing all options*

![Sleeves Options](./images/screenshot-18-sleeves-dropdown-options.png)

*Sleeves dropdown showing all options*
...
*Home Appliances category specification fields*
...
## Variant Relationship with Category
...
![Manage Products Dashboard](./images/screenshot-01-manage-products-dashboard.png)

*Manage Products main page*

![Fashion Dresses Full Page](./images/screenshot-20-fashion-dresses-full-page.png)

*Full page view of Fashion > Dresses category*
