...
![Manage Products Overview](./images/screenshot-01-manage-products-overview.png)

*Main Manage Products page showing the Active tab with search filters and action buttons*
...
![Product Overview Details](./images/screenshot-06-product-overview-expanded.png)

*Expanded Product Overview section showing Product Limitation progress bar and details*
...
![All Products Tab](./images/screenshot-02-all-products-tab.png)

*All tab view showing combined product list and filter options*
...
![Inactive Tab](./images/screenshot-07-inactive-tab-out-of-stock.png)

*Inactive tab with Out Of Stock filter checkbox and empty state message*
...
![Draft Products Tab](./images/screenshot-03-draft-tab-with-product.png)

*Draft tab showing an incomplete product listing with Edit and Delete options*
...
![Search Filter Options](./images/screenshot-05-search-filter-dropdown.png)

*Product Name search filter dropdown showing available search criteria*
...
![Bulk Manage Menu](./images/screenshot-04-bulk-manage-dropdown.png)

*Bulk Manage dropdown displaying available bulk operation options including AI-Powered image management*
...
3. Follow the specific workflow for that operation
4. Bulk operations typically involve:
...
3. Review list of unfinished products
4. Click **Edit** to complete a draft
5. Or click **Delete** to remove unwanted drafts

### Filter Inactive Out-of-Stock Products

1. Navigate to **Products > Manage Products**
2. Click the **Inactive** tab
3. Check the **Out Of Stock** filter checkbox
4. Review products needing inventory replenishment
5. Update stock levels or reactivate products

### Bulk Edit Multiple Products

1. Navigate to **Products > Manage Products**
2. Select a status tab with products
3. Check boxes next to products to edit
4. Click **Bulk Manage** dropdown
5. Select **Bulk Edit**
6. Follow bulk edit workflow
7. Review and confirm changes

### Search for Specific Product

1. Navigate to **Products > Manage Products**
2. Ensure **Product Name** is selected in search dropdown
3. Type product name in search field
4. Click **Search** button
5. Review filtered results
6. Click **Reset** to clear search
...
2. **Complete Drafts:** Finish or delete draft products to keep workspace clean
3. **Monitor Violations:** Address violation tab products immediately to restore sales
4. **Stock Management:** Use Out Of Stock filter regularly to maintain inventory

### Search and Organization

1. **Use Categories:** Filter by category for easier navigation
2. **Descriptive Names:** Use clear product names for easier searching
3. **Bulk Operations:** Leverage bulk tools for efficiency on large catalogs
4. **Sort Strategically:** Use Sort By to prioritize products needing attention

### Performance Tracking

1. **Product Data:** Regularly check Product Data analytics
2. **Active Products:** Keep Active tab optimized for maximum visibility
3. **Quality Control:** Monitor Pending QC tab for approval status
4. **Inactive Review:** Periodically review Inactive products for reactivation opportunities
